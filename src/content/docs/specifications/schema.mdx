---
title: Schema
description: A technical specification of the European Vaccination Card (EVC), focused on schema.
---
...
| **oid**   | string | 1.2.250.1.213.1.4.8 | [OID](/evc_doc/specifications/oid) for the identification scheme       |
